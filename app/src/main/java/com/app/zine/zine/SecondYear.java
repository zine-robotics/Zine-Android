...
public class SecondYear extends Fragment {
    ...
    ListView listView;
    String[] cn={"Akash Sharma","Bhanu Mohindra","Brijraj","Charu","Dhruv Goyal","Harsh Chaudhary","Kshitiz Kamal","Muskan Garg","Nikita Rautela","Pravesh Sandhu","Rajat Agrawal","Saransh Tayal","Sneha Yadav","Vaibhav Agrawal"};
